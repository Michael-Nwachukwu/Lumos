            ...
            <div class="flex flex-row w-full">
                ...
                <div class="flex flex-1 flex-col items-center justify-center px-10 relative">
                    ...
                    <div class="flex flex-1 flex-col justify-center space-y-5 max-w-md">
                        ...
                        <div class="flex flex-col space-y-2 text-center mt-20">
                            <h2 class="text-3xl md:text-4xl font-bold">Sign in to account</h2>
                            <p class="text-md md:text-xl">Sign in to get the best experience with lumos, password is
                                required!</p>
                        </div>

                        <div class="flex flex-col max-w-md space-y-5">

                            <form method="POST" action="/users/authenticate" class="space-y-4">
                                ...
                                <button
                                    class="flex items-center justify-center flex-none px-3 py-2 md:px-4 md:py-3 border-2 rounded-lg font-medium border-black bg-black text-white w-full hover:bg-amber-300">
                                    Sign In
                                </button>
