<x-dashboard>
    ...
    <div class="h-full ml-14 mt-20 mb-10 md:ml-64">
        ...
        <h1 class="text-3xl text-black font-bold text-left px-10 py-7">
            Inbox <br>
            <span class="text-xs text-gray-400 uppercase">Associated messages</span>
        </h1>

        {{-- <!-- Recent Activities --> --}}
        <div class="relative flex flex-col min-w-0 break-words bg-gray-50 dark:bg-gray-800 shadow-lg rounded mx-10">
