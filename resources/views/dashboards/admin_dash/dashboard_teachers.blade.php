                                ...
                                <tr
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center text-sm">
                                            ...
                                            <div>
                                                <p class="font-semibold">{{ $teacher->firstname }} {{ $teacher->lastname }}</p>
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 py-10">
                ...
                <div class="py-6 px-6 lg:px-8">
                    ...
                    <div class="flex items-baseline justify-between">
                        ...
                        <h3 class="mb-4 text-base pt-2 font-medium text-gray-900 dark:text-white">Create Teacher</h3>
                    </div>

                    <form method="POST" action="/create/teacher" enctype="multipart/form-data" class="w-full">
                        ...
                        <div class="grid gap-4 mb-4 md:grid-cols-2 ">
                            ...
                            <div>
                                ...
                                <input type="text" id="last_name"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Doe" required="" name="lastname" value="{{ old('lastname') }}">
                                @error('lastname')
                                    <p class="text-red-500 text-xs mt-1">
                                        {{ $message }}
                                    </p>
                            ...
                            <div>
                                ...
                                <input type="email" id="email"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Flowbite" required="" name="email"
                                    value="{{ old('email') }}">
                                @error('email')
                                    <p class="text-red-500 text-xs mt-1">
                                        {{ $message }}
                            ...
                            <div>
                                ...
                                <input type="tel" id="phone"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="123-45-678" required="" name="phone"
                                    value="{{ old('phone') }}">
                                @error('phone')
                                    <p class="text-red-500 text-xs mt-1">
                                        {{ $message }}
                        ...
                        <div class="hidden">
                            <input name="role" type="hidden" class="hidden" value="1">
                        </div>

                        <div class="hidden">
                            <input name="gender" type="hidden" class="hidden" value="male">
                        </div>

                        <button type="submit"
                            class="text-white bg-black text-white hover:bg-amber-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 hover:text-black">Create
                            User</button>
                    </form>
                </div>
            </div>
