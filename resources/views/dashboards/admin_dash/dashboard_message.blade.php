    ...
    <div class="h-full ml-14 mt-20 mb-10 md:ml-64">
        ...
        <div class="flex items-center justify-between mx-20">
            ...
            <h1 class="text-3xl text-black font-bold py-7">
                Announcements <br>
                <span class="text-xs text-gray-400 uppercase">Send a message</span>
            </h1>
            ...
            <form action="" class="space-y-4">
                ...
                <div>
                    <select id="underline_select"
                        ...
                        <option value="CA">Teachers</option>
                    </select>
                ...
                <div>
                    <div class="mb-6">
                        <label for="default-input"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Message
                            Title</label>
                    ...
                    <div
                        ...
                        <div class="flex justify-between items-center py-2 px-3 border-b dark:border-gray-600">
                            ...
                            <div id="tooltip-fullscreen" role="tooltip"
                                ...
                                style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(0px, 341px);">
                                Show full screen
                ...
                <span class="button-text text-black" style="color: black !important">Send Message</span>
                </button>
