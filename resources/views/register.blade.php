    ...
    <body class="bg-white">
        ...
        <div class="flex h-screen">
            ...
            <div class="flex flex-row w-full">
                ...
                <div
                    ...
                    <div class='space-y-5'>
                        <h1 class="lg:text-2xl xl:text-5xl xl:leading-snug font-extrabold" style="margin-top: -50px">
                            ...
                            experiences</h1>
                        <p class="text-lg">Have an account?</p>
                        <button onclick="window.location.href='/login'"
                            class="inline-block flex-none px-4 py-3 border-2 rounded-lg font-medium border-black bg-black text-white hover:bg-amber-300">Sign
                            in here</button>
                    </div>
                ...
                <!-- register -->
                <div class="flex flex-1 flex-col items-center justify-center relative space-y-2">

                    <form method="POST" action="/users" class="w-9/12 mt-20" enctype="multipart/form-data">
                        @csrf
                        <div class="grid gap-4 mb-4 md:grid-cols-2 ">
                            ...
                            {{-- upload dp --}}
                            <div class="">
                                <label for="profilepicture" class="inline-block text-sm mb-1">
                                    Profile Picture
                                </label>
                        ...
                        <button type="submit"
                            class="text-white bg-black text-white hover:bg-amber-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Sign Up
                        </button>
