 ...
 <div class="max-w-7xl mx-auto shadow-xl">

     <div class="w-full p-4 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700" style="background-color:#ede7e2">
         {{-- drop down header for small screen only --}}
         <div class="sm:hidden">
         ...
         <ul class="hidden text-sm font-medium text-center space-x-6 rounded-lg sm:flex dark:divide-gray-600 dark:text-gray-400"
             id="fullWidthTab" data-tabs-toggle="#fullWidthTabContent" role="tablist">

             <li class="w-full">
                 <button id="stats-tab" data-tabs-target="#stats" type="button" role="tab" aria-controls="stats"
                     aria-selected="true"
                     class="inline-block text-emerald-50 bg-neutral-800 p-4 w-full rounded-tl-lg hover:bg-gray-100 focus:outline-none dark:bg-gray-700 dark:hover:bg-gray-600 hover:text-lime-600 dark:text-blue-500 dark:hover:text-blue-500 dark:border-blue-500">Statistics</button>
             </li>

             <li class="w-full">
                 <button id="about-tab" data-tabs-target="#about" type="button" role="tab" aria-controls="about"
                     aria-selected="false"
                     class="inline-block text-emerald-50 bg-neutral-800 p-4 w-full  hover:bg-gray-100 focus:outline-none dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-transparent hover:text-gray-600 dark:text-gray-400 hover:border-gray-300 dark:border-gray-700 dark:hover:text-gray-300">Services</button>
             </li>
             <li class="w-full">
                 <button id="faq-tab" data-tabs-target="#faq" type="button" role="tab" aria-controls="faq"
                     aria-selected="false"
                     class="inline-block text-emerald-50 bg-neutral-800 p-4 w-full  rounded-tr-lg hover:bg-gray-100 focus:outline-none dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-transparent hover:text-gray-600 dark:text-gray-400 hover:border-gray-300 dark:border-gray-700 dark:hover:text-gray-300">FAQ</button>
             </li>
         </ul>
         <div id="fullWidthTabContent" class="border-t border-gray-200 bg-transparent dark:border-gray-600">

             <div class="p-4 rounded-lg md:p-8 dark:bg-gray-800" id="stats" role="tabpanel"
             ...
             <div class="hidden p-4 bg-transparent rounded-lg md:p-8 dark:bg-gray-800" id="about" role="tabpanel"
                 aria-labelledby="about-tab">
                 <h2 class="mb-5 text-2xl font-extrabold tracking-tight text-gray-900 dark:text-white">We
                     invest in
             ...
             <div class="hidden p-4 bg-transparent rounded-lg md:p-8 dark:bg-gray-800" id="faq" role="tabpanel"
                 ...
                 <div id="accordion-flush" data-accordion="collapse"
                     ...
                     <h2 id="accordion-flush-heading-1">
                         <button type="button"
                             class="flex justify-between items-center py-5 w-full font-medium text-left border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                     ...
                     <div id="accordion-flush-body-1" class="" aria-labelledby="accordion-flush-heading-1">
                         <div class="py-5 font-light border-b border-gray-200 dark:border-gray-700">
                             ...
                             <p class="text-gray-500 dark:text-gray-400">Check out this guide to learn how
                     ...
                     <div id="accordion-flush-body-3" class="hidden" aria-labelledby="accordion-flush-heading-3">
                         <div class="py-5 font-light border-b border-gray-200 dark:border-gray-700"
                             data-summari-content-root="true">
                             ...
                             <ul class="pl-5 list-disc text-gray-500 dark:text-gray-400">
                                 <li><a href="https://flowbite.com/pro/"
                                         ...
                                         data-summari-detected="true">Flowbite Pro</a></li>
                                 <li><a href="https://tailwindui.com/" rel="nofollow"
                                         class="text-blue-600 dark:text-blue-500 hover:underline"
                                         data-summari-detected="true">Tailwind UI</a></li>
                             </ul>
                         </div>
                     </div>
                 </div>
