<x-layout class="bg-stone-700">
    ...
    <br><br><br>
        ...
        @unless($courses->isEmpty())
            <div class="grid grid-cols-2 gap-10 p-10">
                @foreach ($courses as $course)
                    ...
                    {{-- <p class="text-white text-4xl">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Deserunt, dolor?</p> --}}
                    {{-- <li class="splide__slide p-5 ">
                        <div class="mycard">
                            ...
                            <a href="/courses/{{ $course->id }}"
                                ...
                                <img class="object-fill w-full h-full md:h-96 md:w-1/2 md:rounded-none md:rounded-l-lg"
        ...
        @else
            <div class="flex justify-center self-center mt-48">
                <div>
                    <img src="{{ asset('img/undraw_location_search_re_ttoj.svg') }}" class="block w-96" alt="">
                    <h1 class="text-2xl font-bold block text-amber-500">Ooops.. there are no matching results</h1>
                </div>
            </div>
        @endunless
